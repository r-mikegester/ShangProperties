...
const Laya = () => {
    ...
    // Always select Laya project
    const project = projects.find((p) => p.title === "Laya");
                                    ...
                                    <div className="text-center">
                                        ...
                                        {/* <div className="grid lg:grid-cols-2 gap-3">
                                            <div className="grid grid-cols-2 lg:grid-cols-1 gap-3">
                                                {project.gallery.map((img, i) => (
                                                    <figure className="relative w-full h-60" key={i}>
                                                        <img className="size-full absolute top-0 start-0 object-cover rounded-xl" src={img} alt={`${project.title} Gallery ${i + 1}`} loading="lazy" />
                                                    </figure>
                                                ))}
                                            </div>
                                            <figure className="relative w-full h-72 sm:h-96 lg:h-full">
                                                <img className="size-full absolute top-0 start-0 object-cover rounded-xl" src={project.image} alt={project.title} loading="lazy" />
                                            </figure>
                                        </div> */}
                            ...
                            <div className="sticky top-0 start-0 py-6 sm:py-8 lg:ps-8">
                                ...
                                <div className="group flex flex-col sm:flex-row items-center gap-3 border-b border-gray-200 pb-8 mb-8 text-center sm:text-left">
                                    <a className="block shrink-0 focus:outline-hidden" href="#">
                                        <img className="size-10 rounded-full mx-auto sm:mx-0" src={profile} alt="Avatar" />
                                    </a>
