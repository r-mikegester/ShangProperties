                                            ...
                                            <div className="grid grid-cols-2 lg:grid-cols-1 gap-3">
                                                {project.gallery.map((img, i) => (
                                                    <figure className="relative w-full h-60" key={i}>
                                                        <img className="size-full absolute top-0 start-0 object-cover rounded-xl" src={img} alt={`${project.title} Gallery ${i + 1}`} />
                                                    </figure>
                                                ))}
                                            </div>
                                            <figure className="relative w-full h-72 sm:h-96 lg:h-full">
                                                <img className="size-full absolute top-0 start-0 object-cover rounded-xl" src={project.image} alt={project.title} />
                                            </figure>
                                        </div> */}
